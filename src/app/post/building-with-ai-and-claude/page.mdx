...
export const metadata = {
  ...
  thumbnail: "/thumbnails/building-with-ai-and-claude.png",
};
...
_The source code for this website is available on [GitHub](https://github.com/octoio/octoio.dev). Feel free to explore the implementation or use it as inspiration for your own AI-assisted development projects._
