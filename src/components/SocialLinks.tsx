            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-xl ${brandStyle.iconBg} flex-shrink-0 group-hover:scale-110 transition-all duration-300 flex items-center justify-center ${brandStyle.iconColor}`}
                  >
