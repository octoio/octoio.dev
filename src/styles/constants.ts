...
export const COMMON_STYLES = {
  ...
  featuredBadge: "bg-indigo-500 text-white px-3 py-1 rounded-full text-xs font-semibold mb-4 inline-block",
  ...
  // Navigation styles
  backNav: "inline-flex items-center gap-2 text-indigo-500 no-underline mb-12 font-medium transition-colors duration-200 hover:text-indigo-600",
