...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: ({ children, ...props }) => (
      <h1
        className="text-4xl font-semibold text-slate-800 mb-8 mt-0"
        {...props}
      >
        {children}
      </h1>
    ...
    h2: ({ children, ...props }) => (
      <h2
        className="text-3xl font-semibold text-slate-800 mb-6 mt-12"
        {...props}
      >
        {children}
      </h2>
    ...
    ol: ({ children, ...props }) => (
      <ol
        className="text-slate-600 mb-6 pl-6 space-y-2 list-decimal"
        {...props}
      >
        {children}
      </ol>
    ...
    code: ({ children, className, ...props }) => {
      ...
      return (
        <code
          className={`${className || ""} text-slate-100 font-mono text-sm`}
          {...props}
        >
          {children}
        </code>
    ...
    blockquote: ({ children, ...props }) => (
      <blockquote
        className="border-l-4 border-blue-500 pl-6 py-2 my-6 bg-blue-50 italic text-slate-700"
        {...props}
      >
        {children}
      </blockquote>
    ...
    th: ({ children, ...props }) => (
      <th
        className="border border-slate-200 bg-slate-50 px-4 py-2 text-left font-semibold text-slate-800"
        {...props}
      >
        {children}
      </th>
